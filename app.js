...
function processComments(comment) {
    ...
    let message_body = `Thank you for your question, to better assist you I am passing you to our support department. Click the link below to be transferred. https://m.me/maktingbot?ref=${encode_message}`;
    let request_body = {
        "message": message_body
    };

    request({
        "uri": `https://graph.facebook.com/v3.1/${comment_id}/private_replies`,
